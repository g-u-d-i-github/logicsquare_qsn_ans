...
const Dashboard = () => {
  ...
  return (
    ...
    <div className='child'>
        ...
        onChange={setSearch}
        placeholder='Search by name email desg......'
        style={{width:'30rem'}}
      ></input>
      ...
      <Button onClick={()=>{setrefresh(true)}}><RefreshIcon/></Button>
        ...
        <div style={{top:'0',display:'absolute'}}>
  ...
  <Modal show={show} onHide={modalClose} style={{background:'rgba(251, 47, 254,0.5)'}}>  
  ...
  <Modal.Footer>  
    ...
    <div className="App p-4">     
  <Modal show={editshow} onHide={editmodalClose} style={{background:'rgba(153, 243, 15,0.5)'}}>  
  <Modal.Header closeButton>  
    <Modal.Title>Add New Emplyoee</Modal.Title>  
  </Modal.Header>  
